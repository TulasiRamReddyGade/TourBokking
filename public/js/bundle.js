...
var showAlert = function showAlert(type, message) {
  ...
  console.log(markup);
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // console.log('Hello');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'failed to logout');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"leaf.js":[function(require,module,exports) {
"use strict";
...
var showMap = function showMap(locations) {
  var map = L.map('map', {
    zoomControl: false
  });
...
var locationDOM = document.getElementById('map');
var logoutButton = document.querySelector('.nav__el--logout');
var passwordChange = document.querySelector('.form-user-settings'); // const locations = JSON.parse(.dataset.locations);
// console.log(login);

var saveSettings = document.querySelector('.form-user-data'); // console.log(saveSettings);
// console.log(form);

if (locationDOM) (0, _leaf.showMap)(JSON.parse(locationDOM.dataset.locations));
...
if (passwordChange) {
  passwordChange.addEventListener('submit', function (e) {
    e.preventDefault();
...
},{"./login":"login.js","./leaf":"leaf.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
